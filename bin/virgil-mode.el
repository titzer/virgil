(defvar virgil-decls
  '("class" "component" "def" "enum" "extends" "export" "in" "import" "layout" "new" "private" "struct" "super" "type" "var" )
...
(defvar virgil-builtins
  '("void" "int" "byte" "bool" "long" "Array" "Ref" "Range" "true" "false" "this" "string" "float" "double")
