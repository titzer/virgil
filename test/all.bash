...
if [ $# != 0 ]; then
    ...
    TEST_DIRS="unit asm/x86 asm/x86-64 redef core regalloc cast variants enums open_types descriptor wasmgc fsi32 fsi64 float range layout funexpr readonly large pointer vmaddr darwin linux rt stacktrace gc system link lib wizeng apps bench"
fi
